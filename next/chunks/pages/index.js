(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[405], {
    ...
    9158: function(e, t, i) {
        ...
        var S = i(4873);
        function k(e) {
            let t, i, s, n, {loadComplete: a, scroller: c, currentWorkIndex: h, scrolling: m, archiveActive: f, hoverCurrentWorkIndex: w, wkClickIndex: p} = e, v = (0,
            u.useState)(), g = (0,
            u.useRef)([]), x = 0, [k,T] = (0,
            u.useState)(null), C = new d.xsS, E = 0, j = (0,
            u.useRef)(null), I = new d.cPb(30,1,100,1e3), M = (0,
            u.useRef)({}), Z = (0,
            u.useRef)(-2200), b = (0,
            u.useRef)(0), R = (0,
            u.useRef)(!1), L = (0,
            ...
            u.useEffect)(()=>{
                if (0 === Z.current && j.current && !m && null === w) {
                    ...
                    o.ZP.to(j.current.position, .2, {
                        x: t.mesh.position.x
                    }))
                }
                m && (j.current && o.ZP.to(j.current.scale, .2, {
                    x: 0
                }),
                g.current.map((e,t)=>{
                    o.ZP.to(e, .2, {
            ...
            u.useEffect)(()=>{
                if (null !== p) {
                    let e = g.current[p];
                    o.ZP.to(j.current.scale, .2, {
                        x: 0
                    }),
                    o.ZP.to(e.mesh.material.uniforms.uClickProcess, .7, {
                        value: 1,
                        ease: l.Aq.easeOut
                    }),
                    o.ZP.to(e.mesh.material.uniforms.uPlaneSizes.value, .8, {
                        x: window.innerWidth
                    }),
                    o.ZP.to(e.mesh.material.uniforms.uPlaneSizes.value, .9, {
            ...
            let z = e=>{
                    ...
                    let n = new d.dpR().load(r[s].src, ()=>{
                      ...
                      , a = new d.jyz({
                        uniforms: {
                            ...
                            uImageSizes: {
                                value: new d.FM8(1900,950)
                            },
                            uPlaneSizes: {
                                value: new d.FM8(l.width,2.4 * l.width)
                            },
                            uResolution: {
                                value: new d.FM8(t,i)
                            },
              ...
              , B = ()=>{
                ...
                setTimeout(()=>{
                    ...
                    e.to(".pr_info .pr_title_t", 0, {
                        opacity: 0
                    }, 0),
                    e.from(".pr_info .pr_bar", .3, {
                        scaleX: 0
                    }, 1.4),
        ...
        var Z = !0;
        function b(e) {
            let t, {workItems: i} = e, [s,c] = (0,
            u.useState)(0), d = (0,
            E.useRouter)(), [h,m] = (0,
            u.useState)(null), [f,w] = (0,
            u.useState)(null), [p,v] = (0,
            u.useState)(!1), [_,g] = (0,
            u.useState)(!1), [x,P] = (0,
            I.FV)(j.tV), [y,Z] = (0,
            I.FV)(j.NA), [b,R] = (0,
            ...
            let H = (e,t)=>{
                ...
                e.forEach(function(e) {
                    X(e, ()=>{
                        c(++i / r),
                        o.ZP.to(".scroll_info .since_info", .2, {
                            x: 340 * (i / r)
                        }),
                        i == r && t()
                    }
            ...
            let O = ()=>{
              ...
              , V = ()=>{
                ...
                r.style.height = e + "px",
                setTimeout(()=>{
                    document.querySelector(".scroll_info_tl").classList.remove("intro_duration")
                }
                , 2e3),
              ...
              , Y = ()=>{
                ...
                e.map((e,t)=>{
                    ...
                    o.ZP.to(".work_top_info .work_title", 0, {
                        text: i[Math.floor(s) + 1].data.pr_title
                    }),
                    o.ZP.to(".work_top_info .work_index", 0, {
                        text: Math.floor(s) + 2
                    })
                }
                ),
            ...
            let Q = e=>{
                if (P(e),
                Z(i[e].data.images[0].image),
                o.ZP.to(".scrolldown_info", .3, {
                    opacity: 0
                }),
                window.innerWidth > 900) {
                    D(!0),
            ...
            r.jsx)(r.Fragment, {
                ...
                r.jsxs)("div", {
                    className: "main",
                    style: {
                        height: B ? window.innerHeight : "inherit"
                    },
                    children: [(0,
                    r.jsxs)("div", {
                        ...
                        r.jsx)("h2", {
                            ...
                            children: "NOBLE design campaign"
                        }), (0,
                        r.jsxs)("div", {
                    ...
                    r.jsx)("div", {
                        ...
                        r.jsxs)("div", {
                            ...
                            r.jsx)("div", {
                                ...
                                children: 2e3 + Math.floor(s * (Number(new Date().getFullYear()) % 2e3))
                            }), i.length && i.map((e,t)=>{
                    ...
                    r.jsx)("div", {
                        ...
                        r.jsxs)("div", {
                            ...
                            r.jsxs)("div", {
                                ...
                                children: ["Integrated ", (0,
                                r.jsx)("br", {}), "Marketing ", (0,
                                r.jsx)("br", {}), "Communication"]
                            }), (0,
                            r.jsx)("div", {
                    ...
                    r.jsxs)("div", {
                        ...
                        r.jsx)("div", {
                            ...
                            style: {
                                height: B ? window.innerHeight : "800px"
                            }
                        }), (0,
                        r.jsx)("div", {
                            className: "work_wrap",
