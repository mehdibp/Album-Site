    ...
    (t = ()=>{
        ...
        function() {
            let t = e=>e
              ...
              , a = (null == n ? void 0 : n.dataset.endpoint) || (null != n && n.src.includes("/va/") ? "/va" : "/Users/mehdi/Desktop/New%20folder/code/Site/phys-school/Album/vercel/insights")
            ...
            let f = e()
              , v = ()=>{
                ...
                window.va = function(e, n) {
                    "beforeSend" === e ? t = n : "event" === e ? n && d(n.name, n.data) : "pageview" === e && n && (n.route && (r = n.route),
                    n.path && (o = n.path),
                    u({
                        withReferrer: l
                    }),
